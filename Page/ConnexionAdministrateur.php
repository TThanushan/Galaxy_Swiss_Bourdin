...
<head>
	<meta charset="utf-8">
	<title>Galaxy Swiss Bourdin | Connexion Administrateur </title>
...
<body>
	...
	<div class="container">
				...
				<ul class="navbar-nav ml-auto" ">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							...
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="#"><i class="fas fa-user-secret mr-2"></i>Administrateur</a> 
						</div>
		...
		<!-- Hero Section -->
		<div class="jumbotron">
			<h1 class="display-3 text-center"> Connexion Administrateur</h1>
		</div>
		...
		<div class="modal-dialog text-center">
			...
			<div class="col-11 modal-content">
				<div class="col-12 mb-5">
					<i style="font-size: 150px; margin-top: -20px;"class="fas fa-user-secret"></i>
					<p class="lead text-center"> Administrateur </p>

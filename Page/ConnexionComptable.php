...
<head>
	<meta charset="utf-8">
	<title>Galaxy Swiss Bourdin | Connexion Comptable</title>
...
<body>
	...
	<div class="container">
				...
				<ul class="navbar-nav ml-auto" ">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="#"><i class="fas fa-user-tie mr-2"></i>Comptable</a> 
							<div class="dropdown-divider"></div>
		...
		<!-- Hero Section -->
		<div class="jumbotron">
			<h1 class="display-3 text-center"> Connexion Comptable</h1>
			<!-- <p class="lead text-center"> La page de connexion du comptable </p> -->
		</div>
	<?php
		...
		<div class="modal-dialog text-center">
			...
			<div class="col-11 modal-content">
				<div class="col-12 mb-5">
					<i style="font-size: 150px; margin-top: -20px;"class=" fas fa-user-tie"></i>
					<p class="lead text-center"> Comptable </p>
